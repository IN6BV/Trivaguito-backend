...
export const postHabitacion = async (req, res) => {
    ...
    if (hotel) {
        const {tipoHabitacion, capacidadPersonas, precio, fotos, precioPorNoche, disponibleApartir} = req.body;
        const newHabitacion = new Habitacion({tipoHabitacion, capacidadPersonas, precio, fotos, precioPorNoche, disponibleApartir});
...
export const deleteHabitacion = async (req, res) => {
    ...
    if (hotel) {
        ...
        hotel.habitaciones = hotel.habitaciones.filter(habitacion => habitacion.toString() !== id);
